...
$ScaleMode = $pChart['Options']['scaleStart0']?SCALE_ADDALLSTART0:SCALE_ADDALL;
...
$Chart->drawScale($Data,$DataDescription,$ScaleMode,150,150,150,TRUE,0,2,TRUE,$skip);
$Chart->drawGrid(4,TRUE,230,230,230,50);

// Draw the line graph
$Chart->drawStackedBarGraph($Data,$DataDescription,TRUE);
?>
