...
$sql = $sql_debug = str_replace('%where_and_more%', ' AND date BETWEEN :date1 AND :date2', $sql);
//print_r($params);
...
<?}?>
<div id="tabs-3">
<div><a href="excel.php?<?=$_SERVER['QUERY_STRING'] ?>&date1=<?=$_GET['date1']?>&date2=<?=$_GET['date2']?>"><img src="images/excel.png" border="0"/></a></div>
</div>
</div>
</body>
</html>