...
def stat_mosession(my_date):
    ...
    stat_plan=Stat_plan(plan_name='daily-mosession-umniah')
    ...
    stat_plan.add_log_source(r'\\192.168.1.40\log_monet\MoSession_'+date_str) #umniah
    stat_plan.add_log_source(r'\\192.168.1.40\log_monet\MoSession_'+date_next_day_str) #umniah

    stat_plan.add_log_source(r'\\192.168.1.41\log_monet\MoSession_'+date_str) #umniah
    stat_plan.add_log_source(r'\\192.168.1.41\log_monet\MoSession_'+date_next_day_str) #umniah

    #stat_plan.add_log_source(r'\\192.168.1.36\log_monet_umniah\MoSession_'+date_str) #umniah
    #stat_plan.add_log_source(r'\\192.168.1.36\log_monet_umniah\MoSession_'+date_next_day_str) #umniah
