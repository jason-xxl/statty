...
def stat_login(my_date):
    ...
    for i in range(1,10000):
        ...
        logfile=open("c:/logmonet.txt","a") 
        client_jme_fresh_users_mod_3_0=set([user_id for user_id in new_users_fresh_jme if int(user_id) % 3 == 0])
        print  >> logfile,"********jme fresh users1 m3=0 begin*******"
        print >> logfile,client_jme_fresh_users_mod_3_0
        print >> logfile,"********jme fresh users2 end*******"
        
        
        client_jme_fresh_users_mod_3_1=set([user_id for user_id in new_users_fresh_jme if int(user_id) % 3 == 1])
        print  >> logfile,"********jme fresh users1 m3=1 degin*******"
        print >> logfile,client_jme_fresh_users_mod_3_1
        print >> logfile,"********jme fresh users2 end*******"
        
        client_jme_fresh_users_mod_3_2=set([user_id for user_id in new_users_fresh_jme if int(user_id) % 3 == 2])
        print >> logfile,"********jme fresh users1 m3=2 begin*******"
        print >> logfile,client_jme_fresh_users_mod_3_2
        print >> logfile,"********jme fresh users2 end*******"

        client_symbian_fresh_users_mod_3_0=set([user_id for user_id in new_users_fresh_symbian if int(user_id) % 3 == 0])
        print >> logfile,"********symbian fresh users1 m3=0 begin*******"
        print >> logfile,client_symbian_fresh_users_mod_3_0
        print >> logfile,"********symbian fresh users2 end*******"
        client_symbian_fresh_users_mod_3_1=set([user_id for user_id in new_users_fresh_symbian if int(user_id) % 3 == 1])
        print >> logfile,"********symbian fresh users1 m3=1 begin*******"
        print >> logfile,client_symbian_fresh_users_mod_3_1
        print >> logfile,"********symbian fresh users2 end*******"
        client_symbian_fresh_users_mod_3_2=set([user_id for user_id in new_users_fresh_symbian if int(user_id) % 3 == 2])
        print >> logfile,"********symbian fresh users1 m3=3 begin*******"
        print >> logfile,client_symbian_fresh_users_mod_3_2
        print >> logfile,"********symbian fresh users2 end*******"
        logfile.close()
