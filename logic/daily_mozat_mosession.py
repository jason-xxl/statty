...
def stat_mosession(my_date):
    ...
    # NORMAL Wed Aug 17 05:02:20: 35281335,63100000039@fast_globe,2011 8 17 4 57 2,2011 8 17 5 2 20,1941,6887,203.116.22.139,4018
    stat_plan.add_stat_brunch_filters({'only_globe': lambda line : line.find('@fast_globe,') > 0})
    stat_plan.add_stat_brunch_filters({'only_umobile': lambda line : line.find('@fast_umobile,') > 0})
    stat_plan.add_stat_brunch_filters({'only_ais': lambda line : line.find('@fast_ais,') > 0})
    ...
    stat_plan.add_log_source(r'\\192.168.0.110\log_monet\MoSession_'+date_str) #mozat
    stat_plan.add_log_source(r'\\192.168.0.110\log_monet\MoSession_'+date_next_day_str) #mozat

    stat_plan.add_log_source(r'\\192.168.0.135\log_monet_mozat\MoSession_'+date_str) #mozat
    stat_plan.add_log_source(r'\\192.168.0.135\log_monet_mozat\MoSession_'+date_next_day_str) #mozat

    stat_plan.add_log_source(r'\\192.168.0.137\log_monet_mozat\MoSession_'+date_str) #mozat
    stat_plan.add_log_source(r'\\192.168.0.137\log_monet_mozat\MoSession_'+date_next_day_str) #mozat

    stat_plan.add_log_source(r'\\192.168.0.145\log_monet.mozat\MoSession_'+date_str) #mozat
    stat_plan.add_log_source(r'\\192.168.0.145\log_monet.mozat\MoSession_'+date_next_day_str) #mozat

    stat_plan.add_log_source(r'\\192.168.0.181\log_monet_mozat\MoSession_'+date_str) #mozat
    stat_plan.add_log_source(r'\\192.168.0.181\log_monet_mozat\MoSession_'+date_next_day_str) #mozat

    stat_plan.add_log_source(r'\\192.168.0.182\log_monet_mozat\MoSession_'+date_str) #mozat
    stat_plan.add_log_source(r'\\192.168.0.182\log_monet_mozat\MoSession_'+date_next_day_str) #mozat
