...
def is_target_files(line):
    ...
    if file_name.find('globe')>-1:
        return file_name
    return ''

download_last_files=[ 
    '/download/globe-3.sisx',
    '/download/globe-5.sisx',
    '/download/globe.apk',
    '/download/globe.jar',
    '/download/globeFreshmen.jar',
    '/download/globebb46-6.cod', #loose the condition of last file of bb, for bb's last file may vary in different release
    '/download/globebb46-7.cod',
    '/download/globebb47-6.cod',
    '/download/globebb47-7.cod',
    '/download/globebb5-6.cod',
    '/download/globebb5-7.cod',
    '/download/globebb6-6.cod',
    '/download/globebb6-7.cod',
]
...
download_first_files=[ 
    ...
    '/download/globe.jad',
    '/download/globet.jad',
    '/download/globett.jad',
    '/download/globev.jad',
    '/download/globeFreshmen.jad',
    '/download/globebb46.jad',
    '/download/globebb47.jad',
    '/download/globebb5.jad',
    '/download/globebb6.jad',
]
...
def get_unique_id(line):
    ...
    #line=r'2011-09-17 16:15:55 192.168.6.130 GET /download/globet.jad - - 203.177.42.214 Nokia2626/2.0+(04.61)+Profile/MIDP-2.0+Configuration/CLDC-1.1 $Version=0;User-Identity-Forward-msisdn=363339313535343130343834 - 200 6235 203'
    
    msisdn=helper_regex.extract(line,r'User\-Identity\-Forward\-msisdn=(\d{24})')
    if not msisdn:
        return ''
    
    msisdn=''.join((msisdn[1],msisdn[3],msisdn[5],msisdn[7],msisdn[9],msisdn[11],msisdn[13],msisdn[15], \
                    msisdn[17],msisdn[19],msisdn[21],msisdn[23],))
    return msisdn
...
def stat_website(my_date,simple=False):
    ...
    oem_name='Mozat'
    stat_category='website_only_globe'
