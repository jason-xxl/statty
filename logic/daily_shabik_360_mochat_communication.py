...
def stat_mochat(my_date):
    ...
    stat_sql_send_msg_daily_shabik_360=Stat_sql(oem_name=oem_name,stat_category=stat_category, \
                                     ...
                                     where={'send_msg_text':r'(processSendMessagePkt0|PMessagePkt0)','only_shabik_360':is_valid_user}, \
    ...
    stat_plan.add_log_source(r'\\192.168.0.81\log_mochat_shabik_360\morange.log.2012-07-15-00')
    """
